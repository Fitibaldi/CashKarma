...
import { Crown, Mail, Calendar, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      ...
      {isOpen && <div className="space-y-4 mt-4">
        {members.map((member) => (
          <div key={member.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors gap-3">
